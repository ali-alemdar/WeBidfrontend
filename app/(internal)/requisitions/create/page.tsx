...
export default function CreateRequisitionPage() {
  ...
  return (
    <RequireRoles anyOf={["REQUESTER", "REQUISITION_OFFICER", "TENDERING_OFFICER", "SYS_ADMIN"]} title="Create Requisition">
      <InternalPage title="Create Requisition" pageId="REQCRT">
 
       {/* How to start: blank DRAFT vs from internal request */}
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
          {/* Branch 1: New blank requisition */}
          <div className="card" style={{ boxShadow: "none" }}>
            <div style={{ fontWeight: 900, marginBottom: 4 }}>New requisition (blank)</div>
            <div style={{ color: "var(--muted)", marginBottom: 8 }}>
              Create a new requisition from scratch. This will start directly in
              <strong> DRAFT</strong> status using the form below.
            </div>
            <div style={{ color: "var(--muted)", fontSize: 12 }}>
              Fill in the form below and click <strong>Create</strong> to start a new
              DRAFT requisition.
            </div>
          </div>

          {/* Branch 2: From INTERNAL_REQUEST_RECEIVED */}
          <div className="card" style={{ boxShadow: "none" }}>
            <div style={{ fontWeight: 900, marginBottom: 4 }}>
              From internal request (INTERNAL_REQUEST_RECEIVED)
            </div>
            <div style={{ color: "var(--muted)", marginBottom: 8 }}>
              Pick an internal request that was already received and assigned to you.
              Once you select it, it will move to <strong>DRAFT</strong> and open in the
              requisition editor.
            </div>
            <button
              ...
              type="button"
              onClick={() => {
                // Go to status page in "internal-select" mode to list INTERNAL_REQUEST_RECEIVED
                // items to choose from.
                router.push("/requisitions/status?mode=internal-select");
              }}
            >
      ...
      <p style={{ color: "var(--muted)", marginTop: 4 }}>
        The form below creates a new requisition directly in <strong>DRAFT</strong> status.
      </p>
