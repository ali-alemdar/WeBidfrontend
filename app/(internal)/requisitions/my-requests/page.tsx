...
export default function MyRequestsPage() {
  ...
  return (
    <RequireRoles anyOf={["REQUISITION_OFFICER", "REQUISITION_MANAGER", "TENDERING_OFFICER", "SYS_ADMIN"]} title="My requests">
      <InternalPage title="My requests">
        <p style={{ color: "var(--muted)" }}>
          View requisitions you have created. Once submitted, they can be worked on by requisition officers.
        </p>
        ...
        <div className="card" style={{ boxShadow: "none" }}>
          <h3 style={{ marginTop: 0 }}>My created requisitions</h3>
