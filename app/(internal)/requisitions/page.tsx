...
export default function RequisitionsPage() {
  ...
  useEffect(() => {
    const load = async () => {
      try {
        setError("");
        // Load requisitions (same as dashboard)
        ...
        <div>
          <div style={{ marginBottom: 16 }}>
            <div style={{ padding: 16, background: "#f3f4f6", borderRadius: 8 }}>
              <div style={{ fontWeight: 800, marginBottom: 12, fontSize: 16 }}>Requisitions by Status</div>
          ...
          <div style={{ marginBottom: 16 }}>
            <div style={{ display: "flex", gap: 10, alignItems: "center", justifyContent: "space-between" }}>
              ...
              <div style={{ fontWeight: 900, color: "var(--muted)" }}>Total: {requisitions.length}</div>
            </div>
          </div>
