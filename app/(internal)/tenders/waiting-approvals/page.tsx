...
export default function TenderApprovalsPage() {
  ...
  return (
    <RequireRoles anyOf={["TENDERING_OFFICER", "TENDER_APPROVAL", "SYS_ADMIN"]} title="Tenders / Approval Queue">
      <InternalPage title="Tenders / Approval Queue">
        ...
        <div className="card" style={{ boxShadow: "none" }}>
          <h3 style={{ marginTop: 0 }}>Tenders awaiting approval</h3>
